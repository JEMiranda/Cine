...
public class Programacio {
     ...
     * @param funciones
     */
    public Programacio(Date fechaInicio, Date fechaFin, Date fechaHoraCreada, List<Funcion> funciones,List<Cine> cines){
    ...
    public List<Cine> getCines() { return cines; }

    public void setCines(List<Cine> cines) { this.cines = cines; }
